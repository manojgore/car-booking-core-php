                ...
                <div class="user-action-wrap user-sidebar-panel">
                    <div class="notification-item">
                        ...
                        <div class="list-group drop-reveal-list user-drop-reveal-list">
                            ...
                            <a href="employee-logout.php" class="list-group-item list-group-item-action">
    <div class="msg-body">
        <div class="msg-content">
    ...
    <div class="sidebar-nav-body">
        ...
        <div class="author-content">
            <div class="d-flex align-items-center">
                ...
                <h4 class=" font-weight-bold"><?php echo $_SESSION['employee_username']; ?></h4>
                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                ...
                                <h2 class="sec__title font-size-30 text-white">Hi, <?php echo $_SESSION['employee_username']; ?> Welcome Back!</h2>
                            </div>
