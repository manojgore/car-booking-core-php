...
<!-- Mirrored from techydevs.com/demos/trizen/html/car-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Mar 2024 15:11:45 GMT -->
<head>
                ...
                <div class="col-lg-6">
                    <div class="breadcrumb-content">
                        <div class="section-heading">
                            <h2 class="sec__title text-white">Car List</h2>
                        </div>
...
if (mysqli_num_rows($result) > 0) {
    // Iterate over the records and generate HTML dynamically
    while ($row = mysqli_fetch_assoc($result)) {
     
   // Inside the while loop where you generate the car cards
        echo '<div class="card-item car-card card-item-list">';
        echo '<div class="card-img padding-top-50px">';
        echo '<a href="car-single.php" class="d-block">';
        echo '<img src="images/car-img.png" alt="car-img" class="h-100">';
        echo '</a>';
        echo '<span class="badge car-type">' . $row['car_type'] . '</span>';
        echo '<div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Save for later">';
        echo '<i class="la la-heart-o"></i>';
        echo '</div>';
        echo '</div>';
        echo '<div class="card-body">';
        echo '<p class="card-meta car-type">' . $row['car_type'] . '</p>';
        echo '<h3 class="card-title car-name"><a href="car-single.php">' . $row['car_name'] . '</a></h3>';
        echo '<div class="card-rating">';
        echo '<span class="badge text-white car-rating">4</span>';
        echo '<span class="review__text">Average</span>';
        echo '<span class="rating__text">(30 Reviews)</span>';
        echo '</div>';
        echo '<div class="card-attributes">';
        echo '<ul class="d-flex align-items-center">';
        echo '<li class="d-flex align-items-center" data-toggle="tooltip" data-placement="top" title="Passenger"><i class="la la-users"></i><span class="passenger">' . $row['passengers'] . '</span></li>';
        echo '<li class="d-flex align-items-center" data-toggle="tooltip" data-placement="top" title="Luggage"><i class="la la-suitcase"></i><span class="luggage">' . $row['luggage'] . '</span></li>';
        echo '</ul>';
        echo '</div>';
        echo '<div class="card-price d-flex align-items-center justify-content-between">';
        echo '<p>';
        echo '<span class="price__from"></span>';
        echo '<span class="price__num car-price">Rs ' . $row['price'] . '</span>';
        echo '<span class="price__text">upto  <span class="distance">' . $row['distance'] . '</span> Km</span>';
        echo '</p>';
        echo '<form method="post" action="save_to_session.php">';
        echo '<input type="hidden" name="carType" value="' . $row['car_type'] . '">';
        echo '<input type="hidden" name="carName" value="' . $row['car_name'] . '">';
        echo '<input type="hidden" name="passengerCapacity" value="' . $row['passengers'] . '">';
        echo '<input type="hidden" name="luggageCapacity" value="' . $row['luggage'] . '">';
        echo '<input type="hidden" name="price" value="' . $row['price'] . '">';
        echo '<input type="hidden" name="distance" value="' . $row['distance'] . '">';
        echo '<button type="submit" class="btn btn-primary select-btn" name="select">Select</button>';
        echo '</form>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
