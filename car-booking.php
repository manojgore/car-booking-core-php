...
<!-- Mirrored from techydevs.com/demos/trizen/html/car-booking.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Mar 2024 15:11:46 GMT -->
<head>
                ...
                <div class="col-lg-6">
                    <div class="breadcrumb-content">
                        <div class="section-heading">
                            <h2 class="sec__title text-white">Car Booking</h2>
                        </div>
                ...
                <div class="form-box">
                    ...
                    <div class="form-content ">
                        <div class="contact-form-action">
                            <form method="post" action="user-page-3-server.php">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 responsive-column">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="phoneno" placeholder="Phone Number">
                                            </div>
                                        </div>
                                    </div><!-- end col-lg-6 -->
                                    <div class="col-lg-6 responsive-column">
                                ...
                                <button type="submit" id="confirmBookingBtn" class="theme-btn" style="margin-top: 20px;">Confirm Booking</button>
                                <script>
    ...
    <div class="card-item shadow-none radius-none mb-0">
        <div class="card-img pb-4">
            <a href="car-single.php" class="d-block">
                <img src="images/car-img.jpg" alt="car-img">
            </a>
        </div>
        <div class="card-body p-0">
            <div class="d-flex justify-content-between">
                <div>
                    <h3 class="card-title"><?php echo isset($_SESSION['carName']) ? $_SESSION['carName'] : 'null'; ?></h3>
                    <!-- <p class="card-meta"><?php echo isset($_SESSION['country']) ? $_SESSION['country'] : 'null'; ?></p> -->
                </div>
                <div>
                    <a href="car-single.php" class="btn ml-1"><i class="la la-edit" data-toggle="tooltip" data-placement="top" title="Edit"></i></a>
                </div>
            </div>
            <div class="card-rating">
                <span class="badge text-white"><?php echo isset($_SESSION['rating']) ? $_SESSION['rating'] : '4'; ?></span>
                <span class="review__text">Average</span>
                <span class="rating__text"><?php echo isset($_SESSION['reviews']) ? $_SESSION['reviews'] : '12'; ?></span>
            </div>
            <div class="section-block"></div>
            <ul class="list-items list-items-2 list-items-flush py-2">
                <li class="font-size-15"><span class="w-auto d-block mb-n1"><i class="la la-calendar mr-1 font-size-17"></i>Date</span><?php echo isset($_SESSION['pick_date']) ? $_SESSION['pick_date'] : 'null'; ?></li>
                <li class="font-size-15"><span class="w-auto d-block mb-n1"><i class="la la-clock-o mr-1 font-size-17"></i>Time</span><?php echo isset($_SESSION['pick_time']) ? $_SESSION['pick_time'] : 'null'; ?></li>
                <li class="font-size-15"><span class="w-auto d-block mb-n1"><i class="la la-map-marker mr-1 font-size-17"></i>Location</span><?php echo isset($_SESSION['pick_location']) ? $_SESSION['pick_location'] : 'null'; ?></li>
            </ul>
            <h3 class="card-title pb-3">Order Details</h3>
            <div class="section-block"></div>
            <ul class="list-items list-items-2 py-3">
               
                <li><span>Price:</span><?php
               
                echo isset($_SESSION['price']) ? $_SESSION['price'] : 'null'; ?></li>
                <li><span>Passengers:</span><?php echo isset($_SESSION['passengerCapacity']) ? $_SESSION['passengerCapacity'] : 'null'; ?></li>
            </ul>
            <div class="section-block"></div>
            <ul class="list-items list-items-2 pt-3">
                <li><span>Sub Total:</span><?php echo isset($_SESSION['subTotal']) ? $_SESSION['subTotal'] : 'null'; ?></li>
                <li><span>Taxes And Fees:</span><?php echo isset($_SESSION['taxesAndFees']) ? $_SESSION['taxesAndFees'] : 'null'; ?></li>
                <li><span>Total Price:</span><?php echo isset($_SESSION['price']) ? $_SESSION['price'] : 'null'; ?></li>
            </ul>
        </div>
    </div><!-- end card-item -->
</div><!-- end form-content -->
