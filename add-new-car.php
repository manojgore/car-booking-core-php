...
<!-- Mirrored from techydevs.com/demos/trizen/html/add-car.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Mar 2024 15:11:29 GMT -->
<head>
                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-content text-center">
                        <div class="section-heading">
                            <h2 class="sec__title text-white">List your car with the world's <br>
        ...
        <div class="row">
            <div class="col-lg-9 mx-auto">
                <div class="listing-header pb-4">
                    <h3 class="title font-size-28 pb-2">List a car on Trizen</h3>
                ...
                <div class="form-box">
                    <div class="form-title-wrap">
                        <h3 class="title"><i class="la la-gift mr-2 text-gray"></i>Car Details</h3>
                    </div><!-- form-title-wrap -->
                    <div class="form-content contact-form-action">
                        <form method="post" class="row" action="./add-new-car.php">
                            <div class="col-lg-4">
                                <div class="input-box">
                                    <label class="label-text">Car Image</label>
                            ...
                            <div class="col-lg-4">
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <span class="la la-briefcase form-icon"></span>
                                        <input class="form-control" type="text" name="type" placeholder="Car Type" required>
                                    </div>
                                </div>
                            </div><!-- end col-lg-4 -->
                            <div class="col-lg-4">
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <span class="la la-briefcase form-icon"></span>
                                        <input class="form-control" type="text" name="name" placeholder="Car Name" required>
                                    </div>
                                </div>
                            </div><!-- end col-lg-4 -->
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-4">
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <span class="la la-briefcase form-icon"></span>
                                        <input class="form-control" type="number" name="passengers" placeholder="Passengers number" required>
                                    </div>
                                </div>
                            </div><!-- end col-lg-4 -->
                            <div class="col-lg-4">
                            ...
                            <div class="submit-box">
                                <h3 class="title pb-3">Submit Car Details</h3>
                                <div class="custom-checkbox">
                                    <!-- <input type="checkbox" id="agreeChb">
                                    <label for="agreeChb">Check this box to certify that you have provided accurate information about the car.</label> -->
                                </div>
                                <div class="btn-box pt-3">
                                    <button type="submit" class="theme-btn">Submit Details <i class="la la-arrow-right ml-1"></i></button>
                                </div>
                            </div><!-- end submit-box -->
                        </form>
