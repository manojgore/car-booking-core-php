...
<!-- Mirrored from Psyber Inc.com/demos/trizen/html/admin-dashboard-wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Mar 2024 15:11:00 GMT -->
<head>
                        ...
                        <div class="form-box">
                            <div class="form-title-wrap">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="select-contain">
                                  <!-- HTML button element -->
<button id="addCustomerBtn" class="btn btn-primary">Add New Car</button>
                            ...
                            <div class="form-content pb-2">
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo ' <img src="./images/car-img.jpg" alt="" srcset="">';
                                        echo '</div>';
                                        echo '<div class="card-body">';
                                        echo '<p class="card-meta pb-1">Car</p>';
                                        echo '<h3 class="card-title">' . $row['name'] . '</h3>';
                                        echo '<ul class="car-details">';
                                        echo '<li><strong>Type:</strong> ' . $row['type'] . '</li>';
                                        echo '<li><strong>Price:</strong> $' . $row['price_per_day'] . ' per day</li>';
                                        echo '<li><strong>Passengers:</strong> ' . $row['passengers'] . '</li>';
                                        echo '<li><strong>City:</strong> ' . $row['City'] . '</li>';
                                        echo '</ul>';
                                        echo '</div>';
                                        echo '<div class="action-btns">';
                                        echo '<a href="car-single.php" class="theme-btn theme-btn-small bg-danger"><i class="la la-times mr-1"></i>Remove</a>';
                                        echo '</div>';
                                        echo '</div><!-- end card-item -->';
                                    }
                                } else {
                                    echo "0 results";
                                }
                                ...
                                <div class="card-item car-card card-item-list">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="car-details">
                                            ...
                                            <li><strong>Price:</strong> $50 per day</li>
                                    ...
                                    <div class="action-btns">
                                        <a href="car-single.php" class="theme-btn theme-btn-small bg-danger"><i class="la la-times mr-1"></i>Remove</a>
                                    </div>
                                </div><!-- end card-item -->
