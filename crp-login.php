...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = $conn->prepare("SELECT * FROM corporate WHERE email = ?");
    ...
    if ($result->num_rows > 0) {
        ...
        if (($password==$user['password'])) {
            ...
            $_SESSION['corporate_id'] = $user['corporate_id'];
            $_SESSION['corporate_username'] = $user['corporate_username'];
            $_SESSION['corporate_email']=$user['corporate_email'];
...
<!-- Mirrored from techydevs.com/demos/trizen/html/recover.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Mar 2024 15:11:37 GMT -->
<head>
                ...
                <div class="col-lg-6">
                    <div class="breadcrumb-content">
                        <div class="section-heading">
                            <h2 class="sec__title text-white">Corporate Login</h2>
                        </div>
                ...
                <div class="form-box">
                    ...
                    <div class="form-content ">
                        <div class="contact-form-action">
                            <form method="post" action="crp-login.php">
                                <div class="input-box">
    ...
    <div class="modal fade" id="loginPopupForm" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div>
                        <h5 class="modal-title title" id="exampleModalLongTitle2">Corporate Login</h5>
