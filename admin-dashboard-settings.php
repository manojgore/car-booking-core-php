    ...
    <div class="sidebar-nav-body">
        ...
        <div class="sidebar-menu-wrap">
            <ul class="sidebar-menu toggle-menu list-items">
                <li ><a href="admin-dashboard.php"><i class="la la-dashboard mr-2"></i>Dashboard</a></li>
                ...
                <li class="page-active"><a href="admin-dashboard-settings.php"><i class="la la-user mr-2 text-color-2"></i>My Profile</a></li>
                ...
                <button class="theme-btn" type="submit">Save Changes</button>
                    ...
                    <div class="col-lg-6">
                        <div class="form-box">
                            ...
                            <div class="form-content">
                                <div class="contact-form-action">
                                <form action="./admin-email-update.php" method="POST">
                    <div class="row">
