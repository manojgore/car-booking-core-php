...
<!-- Mirrored from Psyber Inc.com/demos/trizen/html/admin-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Mar 2024 15:02:52 GMT -->
<head>
                ...
                <div class="user-action-wrap user-sidebar-panel">
                    <div class="notification-item">
                        ...
                        <div class="list-group drop-reveal-list user-drop-reveal-list">
                            ...
                            <a href="admin-logout.php" class="list-group-item list-group-item-action">
                                <div class="msg-body">
                                    <div class="msg-content">
    ...
    <div class="sidebar-nav-body">
        ...
        <div class="sidebar-menu-wrap">
            <ul class="sidebar-menu toggle-menu list-items">
                <li class="page-active"><a href="admin-dashboard.php"><i class="la la-dashboard mr-2"></i>Dashboard</a></li>
              
                  <li>
                   
                    <a href="admin-dashboard-customer.php"><i class="la la-list mr-2 text-color-2"></i>Customers</a>
                    
                </li>
                <li><a href="admin-dashboard-corporate.php"><i class="la la-building mr-2 text-color-2"></i>Corporate</a></li>
                <li><a href="admin-dashboard-settings.php"><i class="la la-user mr-2 text-color-2"></i>My Profile</a></li>
                <li><a href="admin-cars.php"><i class="la la-car mr-2 text-color-2"></i>Cars</a></li>
                <li><a id="logoutLink" href="admin-logout.php"><i class="la la-power-off mr-2 text-color-11"></i>Logout</a></li>
                                ...
                                <div class="notification-item">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-reveal dropdown-menu-md dropdown-menu-right">
                                            ...
                                            <div class="list-group drop-reveal-list user-drop-reveal-list">
                                                <a href="admin-dashboard-settings.php" class="list-group-item list-group-item-action">
                                                    <div class="msg-body">
                                                        <div class="msg-content">
...
function cancelBooking(bookingId) {
    ...
    if (confirmCancel) {
        ...
        $.ajax({
            ...
            data: { booking_id: bookingId, new_status: 'Cancelled by Admin' },
...
<!-- Mirrored from Psyber Inc.com/demos/trizen/html/admin-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Mar 2024 15:03:06 GMT -->
</html>